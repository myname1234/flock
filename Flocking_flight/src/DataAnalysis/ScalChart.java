...
import DataAnalysis.RChart.DataGenerator;
import flocking_flight.Define;

public class ScalChart extends JPanel
{
	static int count = 1;
	static String filePath = Define.filename1;
    ...
    public ScalChart(int i, String dataName, String chartName) 
    {
