    ...
    public static void main(String[] args) {  
        SwingUtilities.invokeLater(new Runnable() {  
            public void run() {  
                ...
                slider.putClientProperty("Nimbus.Overrides.InheritDefaults",  
                        false);// The ¡°Nimbus.Overrides.InheritDefaults¡± key  
                                // states if the values in ¡°Nimbus.Overrides¡±  
                                // should be merged with the defaults(true) or  
                                // replace them(false).  
