...
public class RealTimeChart extends JPanel
{
    ...
    public RealTimeChart(int i, String filePath, String dataName, String chartName)
    {
    ...
    {
        JFrame jframe = new JFrame("Wscal");
        RealTimeChart demo = new RealTimeChart(30000, "C:\\Users\\WangXinyu\\Desktop\\FLOCK\\Wscal\\1.txt", "Wsacl", "W");
        jframe.getContentPane().add(demo, "Center");
        //jframe.setBounds(200, 120, 600, 400);
        jframe.setVisible(true);
        (demo. new DataGenerator(100)).start();
